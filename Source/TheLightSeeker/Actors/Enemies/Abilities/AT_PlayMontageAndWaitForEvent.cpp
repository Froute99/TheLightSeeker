...
void UAT_PlayMontageAndWaitForEvent::Activate()
{
	...
	if (AbilitySystemComponent.IsValid())
	{
		...
		if (AnimInstance != nullptr)
		{
			...
			{
				UE_LOG(LogTemp, Warning, TEXT("UGDAbilityTask_PlayMontageAndWaitForEvent call to PlayMontage failed1!"));
			}
		}
		else
		{
			UE_LOG(LogTemp, Warning, TEXT("UGDAbilityTask_PlayMontageAndWaitForEvent call to PlayMontage failed2!"));
		}
	}
	else
	{
